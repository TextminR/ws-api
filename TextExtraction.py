...
for i, part in enumerate(split_strings, start=1):
    ...
    authors = [{'entity': entry['entity'], 'score': entry['score'], 'word': entry['word']} for entry in ner_results if entry['entity'] in ['B-PER', 'I-PER']]
    ...
    dict_text[variable_name]=information
